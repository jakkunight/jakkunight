	...
	return (
		<Frame>
			...
			<Text>
				...
				llamado <b><i>razonamiento</i></b>. Eso es algo propio de los humanos. Es la barrera 
				que los separa de nosotros a pesar de su gran capacidad. En cualquier caso, cómo 
				lo hacen? Digo, si no pueden razonar, cómo son capaces, por ejemplo, de saber que 
				deben mostrar una lista concreta de opciones en una app de control financiero?
				¿Cómo es que lo hacen?<br/>
				La respuesta es simple: Un <b>instructivo</b>. Cualquier cosa, incluso las personas, 
				con cierta capacidad para seguir instrucciones, puede hacer grandes cosas, aunque 
			...
			<Text>
				...
				Lo cierto es que no hay una única respuesta, puesto que dependerá del contexto y 
				resultados específicos que queremos lograr mediante la ejecución de nuestros 
				programas. Por suerte, hay un concepto que, en conjunto con la programación, 
				arroja luz en nuestra confusión. Ese es el concepto de <b>informática</b>.<br/>
				La informática es la ciencia que se ocupa del <i>tratamiento automatizado</i> de <i>datos </i>
				para obtener <i>información</i>. Un dato es una simple representación de algo. 
				Por ejemplo, la cantidad de kilogramos que pesa una persona, el color de su piel, la 
				edad, la raza, el sexo, etc. Todas ellas carecen de sentido hasta que las procesamos 
				y las convertimos en información, la cual tiene la particulariadad de poder influir 
				en nuestra toma de decisiones.<br/>
				Si por ejemplo digo un número, el cinco, y te pregunto qué harías luego de saber eso, 
				probablemente dirías que nada, porque el <i>número no significa nada</i>. Pero si luego 
