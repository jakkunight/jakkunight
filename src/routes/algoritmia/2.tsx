	...
	return (
		<Frame>
			...
			<p>
				...
				a automatizar nuestro trabajo.<br/>
				...
				exactos o límites físicos. La misma debe cumplir con un par de características:<br/>
			</p>
			<ul>
				<li>
					<b>[*]</b> Cuenta con un procesador (CPU) de <i>potencia de cálculo infinita</i>. 
					El procesador, o CPU, es el componente que ejecuta las intrucciones de nuestro 
					programa <i>paso a paso</i> y en el orden en el que las va leyendo.<br/>
				</li>
				<li>
					<b>[*]</b> Cuenta con una memoria principal (RAM) de <i>capacidad infinita</i> y 
					...
					procesador necesita para ejecutar los programas.<br/>
				</li>
				<li>
					<b>[*]</b> Cuenta con un teclado y un monitor, que se suponen de <i>velocidad instantánea</i>.
				...
				<li>
					<b>[*]</b> Cuenta con almacenamiento secundario, ("disco"), de <i>capacidad infinita</i>. 
					...
					pueden guardar todo tipo de datos bajo un esquema de <i>archivos y directorios</i>.<br/> 
				</li>
				<li>
					<b>[*]</b> Cuenta con un bus de <i>velocidad infinita</i>. El bus es el componente que 
					...
					ejecuten instrucciones guardadas en la RAM o el estado del procesador.<br/>
				</li>
			</ul>
			<p>
